...
void ApplyPreset(Actor * actor, TESRace * race, TESNPC * npc, PresetDataPtr presetData, MorphHandler::ApplyTypes applyType)
{
	...
	if (g_overrideInterface && (applyType & MorphHandler::ApplyTypes::kPresetApplyOverrides) == MorphHandler::ApplyTypes::kPresetApplyOverrides) {
	...
	if (g_overrideInterface && (applyType & MorphHandler::ApplyTypes::kPresetApplySkinOverrides) == MorphHandler::ApplyTypes::kPresetApplySkinOverrides)
	{
	...
	if (g_transformInterface && (applyType & MorphHandler::ApplyTypes::kPresetApplyTransforms) == MorphHandler::ApplyTypes::kPresetApplyTransforms) {
	...
	if (g_bodyMorphInterface && (applyType & MorphHandler::ApplyTypes::kPresetApplyBodyMorphs) == MorphHandler::ApplyTypes::kPresetApplyBodyMorphs) {
